# =============================================================
# PitSimulator — HAL "rc522" (VARIANTE CONGELADA, generada)
#
# Generado por firmware/frozen_hal/build_components.js a partir de
# components/rc522/rc522.hal.py -- NO EDITAR A MANO. Cualquier
...
from _pit_base import Pin, register_line_handler
