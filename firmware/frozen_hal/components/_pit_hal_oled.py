# =============================================================
# PitSimulator — HAL "oled" (VARIANTE CONGELADA, generada)
#
# Generado por firmware/frozen_hal/build_components.js a partir de
# components/oled/oled.hal.py -- NO EDITAR A MANO. Cualquier
...
from _pit_base import Pin, _settle, poll_input, register_line_handler
