# =============================================================
# PitSimulator — Bus ADC compartido (dummy) (VARIANTE CONGELADA)
#
# Copia de components/_adc_bus/_adc_bus.hal.py del repo del simulador
# -- ver la nota grande de _pit_base.py (misma carpeta). Único
# agregado real: el import de poll_input/register_line_handler justo
# antes de "class ADC" (este módulo, congelado, tiene su propio
# namespace -- sin eso, "register_line_handler(...)" más abajo
